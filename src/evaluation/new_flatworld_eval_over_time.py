...
def set_env():
    ...
    world_info_paths = []
    if os.path.exists(f'eval_datasets/{env_name}/worlds1'):
        world_info_paths = [f'eval_datasets/{env_name}/worlds1/world_info_{i}.pkl' for i in range(num_eval_episodes)]
...
gcn_config = model_configs['gnn_FlatWorld-v0']
deepsets_config = model_configs['FlatWorld-v0']
# transformers_config = model_configs['big_transformer_ChessWorld-v1']

exp_gnn = 'gcn_update'
exp_deepsets = 'deepsets_stay'
