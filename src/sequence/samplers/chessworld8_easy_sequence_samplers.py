...
from envs.chessworld import ChessWorld8Easy

chessworld = ChessWorld8Easy()
...
def chessworld8easy_all_reach_tasks(depth: int) -> Callable:
...
def chessworld8easy_sample_reach(depth: int | tuple[int, int]) -> Callable:
...
def chessworld8easy_all_reach_avoid():
    def wrapper(_):
        seqs = []
...
def chessworld8easy_sample_reach_avoid(
...
# def chessworld8easy_sample_reach_stay(num_stay: int, num_avoid: tuple[int, int]) -> Callable[[list[str]], LDBASequence]:
#     def wrapper(propositions: list[str]) -> LDBASequence:
#         reach = random.choice(all_assignments)
...
if __name__ == '__main__':
    ...
    # print(chessworld8easy_all_reach_tasks(2)(["a"]))
    # print(chessworld8easy_all_reach_avoid()())
