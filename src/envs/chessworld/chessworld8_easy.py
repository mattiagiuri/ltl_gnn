...
class ChessWorld8Easy(gym.Env):
    ...
    ATTACKED_SQUARES = {
        ...
        "knight": {(3, 4), (4, 2), (5, 3), (5, 5), (4, 6),
                   (2, 6), (1, 5), (1, 3), (2, 2)},
        "bishop": {(5, 7), (6, 6), (7, 5), (4, 6), (3, 5), (2, 4), (1, 3), (0, 2)},
        "pawn": {(4, 3), (5, 2), (5, 4)}

    }

    FREE_SQUARES = {(0, 1), (1, 1), (2, 1), (3, 1), (4, 1), (5, 1),
                    (1, 2), (3, 2), (6, 2), (0, 3), (2, 3), (3, 3),
                    (0, 4), (1, 4), (4, 4), (6, 4),
                    (0, 5), (2, 5), (4, 5), (6, 5), (0, 6), (1, 6), (3, 6), (5, 6),
                    (0, 7), (1, 7), (2, 7), (3, 7), (4, 7), (6, 7)}

    def __init__(self, continuous_actions=False):
        # free = (set([(i, j) for i in range(8) for j in range(8)]) -
        ...
        assert (self.FREE_SQUARES ==
                    (set([(i, j) for i in range(8) for j in range(8)]) -
                     set.union(*[attacked for attacked in self.ATTACKED_SQUARES.values()])
                    )
                )
    ...
    def step(self, action: ActType) -> tuple[ObsType, float, bool, bool, dict[str, Any]]:
        ...
        terminated = False
        reward = 0.0
        if (self.agent_pos < 0).any() or (self.agent_pos > 7).any():
            terminated = True
            reward = -1.0
...
if __name__ == '__main__':
    env = ChessWorld8Easy(continuous_actions=False)
    obs, _ = env.reset()
    print(len(env.FREE_SQUARES))
    # trajectory = [obs]
    # for i in range(300):
