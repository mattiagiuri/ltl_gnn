...
# * Changed the angle cosine to match gymnasium InvertedPendulum-v4
# * Increased the valid cart range
#

"""Modified cartpole domain."""
...
class LTLCartpole(base.Task):
    ...
    def is_terminated(self, physics):
        ...
        angle_in_bounds = rewards.tolerance(physics.pole_angle_cosine(),
                                            self._ANGLE_COSINE_RANGE).prod()
        return not bool(int(cart_in_bounds * angle_in_bounds))
