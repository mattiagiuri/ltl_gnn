# Adapted from Shimmy (MIT License): https://github.com/Farama-Foundation/Shimmy/blob/main/shimmy/utils/dm_env.py
...
def dm_env_step2gym_step(timestep) -> tuple[Any, float, bool, bool, dict[str, Any]]:
    ...
    if timestep.last():
        ...
        if timestep.discount > 0:
            ...
            terminated = True
    terminated = terminated or timestep.observation["terminated"]
